                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Manage Users <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="form_advanced.html">Remove User</a></li>
                                        <li><a href="form_validation.html">Edit User</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Manage Environments<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="form.html">New Environment</a></li>
                                        <li><a href="form_advanced.html">Remove Environment</a></li>
                                        <li><a href="form_validation.html">Edit Environment</a></li>
                                    </ul>
                                </li>
