    ...
    <section class="sidebar">
        ...
        <!-- /.search form -->
																	...
																	while ($data = mysql_fetch_array($result)){
																		...
																		$resultz=mysql_query($sqlz);
																				...
																				if ($custom == "NO")			
																					...
																					$pagename=$dataz['pagename'];
																					print "<li><a onClick=load_page(\"$pagename?task=".$taskid."&product=".$product_name."&project=".$_SESSION['project']."\")>".$taskname."</a></li>";
                 																}
																		}    
                 														print "</ul></li>";
                 									}    
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-bug"></i>External Links<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
				        <li><a onClick=openInNewTab('http://10.124.30.56:8080/')>VM Cloning Jenkins</a> 
                                        </li>
                                        <li><a onClick=openInNewTab('https://cmisbbsoweb/Citrix/xenappWeb/')>Xenapp Web</a>
                                        </li>
                                        <li><a onClick=openInNewTab('http://uts')>uts</a></li>
					<li><a onClick=openInNewTab('https://cmiitimprdweb/itim/self/Login/Logon.do')>Tivoli</a>
                                        </li>
					<li><a onClick=openInNewTab('http://cmiweb1/sitepmo/cmiUidTracker/cmiUidTracker-search.asp')>CMI UID Tracker</a>
                                        </li>
                                    </ul>
                                </li>
                         </ul>
            ...
            <div class="top_nav">
                ...
                <div class="nav_menu">
				    ...
				    <li><a href="mailto:iTechnologiesSelf ServiceAdminTeam@int.Accenture.com?subject=Self Service Tool Support Request"><i class="fa fa-envelope-o pull-right"></i> Contact Us</a>
                                    </li>
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
					...
					$tasktime = $data['dttm'];
					$sqlz="SELECT * from tasks where taskid='".$taskname."' and (project_name='".$_SESSION['project']."' or project_name='All') and privs >= ".$_SESSION['emp_profile'] or privs == 5;
					$resultz=mysql_query($sqlz);
					while ($dataz = mysql_fetch_array($resultz)){
						$taskname2 = $data3['taskname'];
						print "<tr><th scope=\"row\">$i</th><td>$taskname2</td><td>$tasktime</td><td>Performed on system ".$envname." by ".$username." <a>Read&nbsp;More</td></tr>";
					}
                    		      }    
                 		      ?>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				      ...
				      $i++;
				      	$taskname = $data[0];
					$envname= $data[1];
			               	$sql3="SELECT * from tasks where taskid='".$taskname."' and (project_name='".$_SESSION['project']."' or project_name='All') and privs >= ".$_SESSION['emp_profile'] or privs == 5;
					$result3=mysql_query($sql3);
    					while ($data3 = mysql_fetch_array($result3)){
						$taskname2 = $data3['taskname'];
						$taskid2 = $data3['taskid'];
						$product_name2 = $data3['product_name'];
						print "<tr><th scope=\"row\">$i</th><td><a onClick=load_page('dispTask.php?task=".$taskid2."&product=".$product_name2."&project=".$_SESSION['project']."')>".$taskname2."</a></td></tr>";
					}	
                    		      }    
                 		      ?>
	 ...
	 <!-- top tiles -->
		    	...
		    	<marquee behavior="scroll" direction="left" scrollamount="6">
					...
					$tasktime = $data['dttm'];
					print " <font size=4 color=green><b>$i.$ntype</b> : </b></font><font color=blue size=4>$notify &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>";
                    		      }    
                 		      ?>	
