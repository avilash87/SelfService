...
print "<center><font color=Green>".$project_name." Added To Self Service!!!</font></center>";
        	  ...
        	  <div id="login" class="animate form">
                <section class="login_content">
                    <form method=POST action="newProj.php">
                        ...
                        <div><input type="text" class="form-control" placeholder="Project Name" required="" name="projname" id="projname" /></div>
                        <div>
